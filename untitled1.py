...
df_graphs=df.drop(['total marks', 'Total marks'],axis=1)
...
header_two=['Attendance', 'Practice',  'Service', 'Grit','Attitude','Total marks']
...
def pdf_creator(uniqename):
    # storing image path 
    img_path = 'D:/gurukulam marks program/dance/backpage/'+uniquename+'.png'     
    # storing pdf path 
    pdf_path = 'D:/gurukulam marks program/dance/backpage/'+uniquename+'.pdf'     
    # opening image 
